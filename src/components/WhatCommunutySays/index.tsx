...
// import { Carousel, CarouselContent, CarouselItem } from "../global/components/ui//carousel";
import { useEffect, useState } from "react";
import { Avatar, AvatarFallback, AvatarImage } from "../global/components/ui/avatar";
import { Button } from "../global/components/ui/button";

export function WhatCommunitySays() {
    ...
    const getCardPattern = (index: number) => {
        switch (index) {
            case 0:
                    ...
                    <div className="bg-white rounded-3xl border-2 border-gray-100 shadow-sm p-8 md:p-12 overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                            <div>
                                ...
                                <div className="space-y-3">
                                    {faqs.map((faq, index) => (
                                        <div
                                            key={index}
                                            className={`p-5 rounded-2xl transition-all duration-300 cursor-pointer ${faqCurrent === index ? 'bg-black text-white' : 'bg-gray-50 hover:bg-gray-100'
                                                }`}
                                        ...
                                        >
                                            <div className="flex justify-between items-center">
                                                ...
                                                {faqCurrent === index && (
                                                    <div className={`h-3 w-3 rounded-full ${index === 0 ? 'bg-amber-300' :
                            ...
                            <div>
                                ...
                                <div
                                    className={`p-8 rounded-2xl min-h-[220px] transition-colors duration-500 relative overflow-hidden ${faqCurrent === 0 ? 'bg-amber-200' :
                                ...
                                >
                                    <div className="flex gap-2 items-center mb-4">
                                        <div className={`h-4 w-4 rounded-full transition-colors duration-500 ${faqCurrent === 0 ? 'bg-amber-50' :
